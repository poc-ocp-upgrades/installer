...
func (m *Manifests) generateBootKubeManifests(dependencies asset.Parents) []*asset.File {
	...
	dependencies.Get(clusterID, installConfig, etcdCA, etcdSignerCertKey, etcdCABundle, etcdSignerClientCertKey, etcdClientCertKey, etcdMetricCABundle, etcdMetricSignerClientCertKey, mcsCertKey, rootCA)
