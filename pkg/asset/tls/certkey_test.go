...
func TestSignedCertKeyGenerate(t *testing.T) {
	...
	for _, tt := range tests {
		t.Run(tt.name, func(t *testing.T) {
			...
			opts := x509.VerifyOptions{Roots: certPool, DNSName: tt.certCfg.Subject.CommonName}
