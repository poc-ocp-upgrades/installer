...
func TestClusterName(t *testing.T) {
	...
	cases := []struct {
		...
		clusterName	string
		valid		bool
	}{{"empty", "", false}, {"only whitespace", " ", false}, {"single lowercase", "a", true}, {"single uppercase", "A", false}, {"contains whitespace", "abc D", false}, {"single number", "1", true}, {"single dot", ".", false}, {"ends with dot", "a.", false}, {"starts with dot", ".a", false}, {"multiple labels", "a.a", true}, {"starts with dash", "-a", false}, {"ends with dash", "a-", false}, {"label starts with dash", "a.-a", false}, {"label ends with dash", "a-.a", false}, {"invalid percent", "a%a", false}, {"only non-ascii", "日本語", false}, {"contains non-ascii", "a日本語a", false}, {"max size", maxSizeName, true}, {"too long", maxSizeName + "a", false}}
...
func TestDomainName_AcceptingTrailingDot(t *testing.T) {
	...
	cases := []struct {
		domain	string
		valid	bool
	}{{"", false}, {" ", false}, {"a", true}, {".", false}, {"日本語", false}, {"日本語.com", false}, {"abc.日本語.com", false}, {"a日本語a.com", false}, {"abc", true}, {"ABC", false}, {"ABC123", false}, {"ABC123.COM123", false}, {"1", true}, {"0.0", true}, {"1.2.3.4", true}, {"1.2.3.4.", true}, {"abc.", true}, {"abc.com", true}, {"abc.com.", true}, {"a.b.c.d.e.f", true}, {".abc", false}, {".abc.com", false}, {".abc.com", false}}
	for _, tc := range cases {
...
func TestDomainName_RejectingTrailingDot(t *testing.T) {
	...
	cases := []struct {
		domain	string
		valid	bool
	}{{"", false}, {" ", false}, {"a", true}, {".", false}, {"日本語", false}, {"日本語.com", false}, {"abc.日本語.com", false}, {"a日本語a.com", false}, {"abc", true}, {"ABC", false}, {"ABC123", false}, {"ABC123.COM123", false}, {"1", true}, {"0.0", true}, {"1.2.3.4", true}, {"1.2.3.4.", false}, {"abc.", false}, {"abc.com", true}, {"abc.com.", false}, {"a.b.c.d.e.f", true}, {".abc", false}, {".abc.com", false}, {".abc.com", false}}
	for _, tc := range cases {
		t.Run(tc.domain, func(t *testing.T) {
...
func TestDoCIDRsOverlap(t *testing.T) {
	...
	cases := []struct {
		...
		b	string
		overlap	bool
	}{{a: "192.168.0.0/30", b: "192.168.0.3/30", overlap: true}, {a: "192.168.0.0/30", b: "192.168.0.4/30", overlap: false}, {a: "192.168.0.0/29", b: "192.168.0.4/30", overlap: true}, {a: "0.0.0.0/0", b: "192.168.0.0/24", overlap: true}}
	for _, tc := range cases {
...
func TestURI(t *testing.T) {
	...
	cases := []struct {
		...
		uri	string
		valid	bool
	}{{name: "valid", uri: "https://example.com", valid: true}, {name: "missing scheme", uri: "example.com", valid: false}}
	for _, tc := range cases {
		t.Run(tc.name, func(t *testing.T) {
			err := URI(tc.uri)
			if tc.valid {
